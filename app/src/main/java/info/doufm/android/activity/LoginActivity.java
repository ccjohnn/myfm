...
public class LoginActivity extends ActionBarActivity implements View.OnClickListener, CompoundButton.OnCheckedChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_PORTRAIT);//使竖直
        context = this;
    ...
    private void Login() {
        if (checkUserInputInfo()) {
            ...
            JsonObjectPostRequest jsonObjectPostRequest = new JsonObjectPostRequest(NetworkConstans.LOGIN_URL, new Response.Listener<JSONObject>() {
                @Override
            ...
            RequestManager.getRequestQueue(this).add(jsonObjectPostRequest);
        }
    }
