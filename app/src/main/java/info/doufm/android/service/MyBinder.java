...
public class MyBinder extends Binder {
    ...
    public List<MusicInfo> currentListenHistory;//当前的历史音乐列表
    ...
    public void setConverImage(MusicInfo musicInfo){//根据url,请求图片
    ...
    private void doSetMusicChannle(){
        ...
        leftMusicChannelList.setAdapter(adapter);//绑定适配器
    }
...
//volley download file is so terrible, so we don't use it generally
